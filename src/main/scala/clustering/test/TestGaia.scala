...
object TestGaia {
  ...
  def main(args: Array[String]) {
    ...
    val result1 = ClusteringIndexes.estimateNumberClusters(scaledVectorData1, seqK.toList, index = index, method = method, repeticiones = numRepeticiones)
